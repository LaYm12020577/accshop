  ...
  <body>
    ...
    <header>
      <nav>
        ...
        <ul class="nav-links">
          ...
          <li>
            <a href="../html files/add_post.php">
              <span class="icon"
    ...
    <section class="banner" style="overflow-x: hidden">
      ...
      <div class="controls">
        ...
        <div class="chatnotlink">
          <ion-icon name="close-circle-outline" class="removechatlink" onclick="chatclosehavent();"></ion-icon>
            <h1>This page is not active in this moment... :( Sorry!</h1>
          </div>
    </section>
    ...
    <script src="../jsfiles/ap.js"></script>
